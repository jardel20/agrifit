...
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1"
  ...
  if (n < 5) stop("O modelo cúbico requer no mínimo 5 pontos de dose.")
  ...
  for (i in 1:n_respostas) {
    ...
    resultado_df <- data.frame(
      ...
      parametro = c("b0_intercepto", "b1_linear", "b2_quadratico", "b3_cubico", "R2", "RMSE", "AIC", "BIC",
                    "p_valor_b0", "p_valor_b1", "p_valor_b2", "p_valor_b3",
                    "ic_b0_low", "ic_b0_high", "ic_b1_low", "ic_b1_high",
                    "ic_b2_low", "ic_b2_high", "ic_b3_low", "ic_b3_high", "df_residual"),
      valor = c(b0, b1, b2, b3, R2, RMSE, AIC_val, BIC_val, p_b0, p_b1, p_b2, p_b3,
                ic_b0_low, ic_b0_high, ic_b1_low, ic_b1_high,
                ic_b2_low, ic_b2_high, ic_b3_low, ic_b3_high, df_res),
      stringsAsFactors = FALSE
    )
    
    equacao_str <- sprintf("%s: Ŷ = %.4f + %.4fX + %.4fX² + %.4fX³", nome_resposta, b0, b1, b2, b3)
