...
Signif. codes:  0 ‘***’ 0.001 ‘****’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1"
  ...
  if (n < 3) stop("O modelo linear requer no mínimo 3 pontos de dose.")
  ...
  for (i in 1:n_respostas) {
    ...
    resultado_df <- data.frame(
      ...
      parametro = c("b0_intercepto", "b1_declividade", "R2", "RMSE", "AIC", "BIC",
                    "p_valor_b0", "p_valor_b1", "ic_b0_low", "ic_b0_high",
                    "ic_b1_low", "ic_b1_high", "df_residual"),
      valor = c(b0, b1, R2, RMSE, AIC_val, BIC_val, p_b0, p_b1,
                ic_b0_low, ic_b0_high, ic_b1_low, ic_b1_high, df_res),
